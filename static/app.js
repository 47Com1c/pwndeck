...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (localStorage.getItem('pwndeck_theme') === 'light') applyTheme('light');
...
function applyTheme(theme) {
  ...
  if (theme === 'light') {
    ...
    localStorage.setItem('pwndeck_theme', 'light');
  } else {
    document.body.classList.remove('light');
    if (btn) btn.innerHTML = '<span>☀</span> LIGHT';
    localStorage.setItem('pwndeck_theme', 'dark');
  }
